          ...
          <div className="z-10 flex col-span-3 mx-auto mt-3 bg-white p-4 space-x-10">
            <div className ='flex flex-col col-span-3 mx-auto mt-3 bg-white p-4 space-x-10'>
              ...
              <div className="flex text-sm font-semibold cursor-pointer">
                <button onClick={() => setSearchInput('')} className="flex-grow cursor-pointer">
                  Cancel
                </button>
                <Link
                  href={{
                ...
                >
                  <button className="flex-grow text-primary cursor-pointer">Search</button>
                </Link>
              </div>
            </div>
            <div className = 'space-y-3'>
              ...
              <p className = 'text-lg font-semibold '>Price</p>
               <div>
                 <input type="number" placeholder = 'min price' className = 'w-32 outlin-enone pl-2 text-lg text-primary' />
                 <input type="number" placeholder = 'max price'  className = 'w-32 outlin-enone pl-2 text-lg text-primary'/>
               </div>
              </div>
              <div className="form-control space-y-3">
                <p className = 'text-lg font-semibold '>Difficulty</p>
                <label className="cursor-pointer space-x-5 items-center flex ">
                  <input type="radio" name="radio-6" className="radio checked:bg-green-500" checked />
                  <span className="label-text">Easy</span> 
                </label>
                <label className="cursor-pointer space-x-5 items-center flex ">
                  <input type="radio" name="radio-6" className="radio checked:bg-yellow-500" checked />
              ...
              <div className='flex items-center border-b mb-4'>
                        <h2 className = 'p-2 flex-grow text-lg font-semibold'>Number of Guests</h2>
                        <UsersIcon className = 'h-5 '/>
                        <input type="number" className ='w-12 outlin-enone pl-2 text-lg text-primary'min ='1' 
                        value = {numberGust}
