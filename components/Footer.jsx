  ...
  return (
    <footer className = 'relative gap-y-10 px-32 py-14 cursor-pointer bg-gray-100 grid grid-clos-1 md:grid-cols-4 text-gray-800 dark:bg-gray-800 dark:text-white'>
        <div className = 'space-y-4 text-xs text-gray-800 dark:text-gray-100'>
            ...
            <p className = 'hover:text-primary'>How Addis Constrution works</p>
            <p className = 'hover:text-primary'>News room</p>
            <p className = 'hover:text-primary'>Investors</p>
            <p className = 'hover:text-primary'>Addis Constrution Plus</p>
            <p className = 'hover:text-primary'>Addis Constrution Luxe</p>
        </div>
        <div className = 'space-y-4 text-xs text-gray-800 dark:text-gray-100'>
            <h5 className = 'font-bold'>COMMUNITY</h5>
            <p className = 'hover:text-primary'>Accessibility</p>
            <p className = 'hover:text-primary'>This is not a real site</p>
            <p className = 'hover:text-primary'>Its a pretty awesomw clonw</p>
        ...
        <div className = 'space-y-4 text-xs text-gray-800 dark:text-gray-100'>
            ...
            <p className = 'hover:text-primary'>Habesha TechCamp</p>
        ...
        <div className = 'space-y-4 text-xs text-gray-800 dark:text-gray-100'>
            ...
            <p className = 'hover:text-primary'>Say Hi YouTube</p>
